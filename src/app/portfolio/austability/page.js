...
export const metadata = {
  title: "What is the Austability Platform? | Radical Thinking",
  description:
    "Austability is a comprehensive enterprise website and digital infrastructure for global defense logistics.",
  openGraph: {
    title: "What is the Austability Platform?",
    description:
      "Comprehensive enterprise website and digital infrastructure for global defense logistics.",
    url: "https://radical-thinking.net/portfolio/austability",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/austability.webp",
        width: 1200,
        height: 630,
        alt: "Austability Platform Interface",
      },
    ],
  },
};
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from operational data to optimize global logistics in real-time.
          </p>
