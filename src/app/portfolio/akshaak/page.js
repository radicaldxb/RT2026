...
export const metadata = {
  title: "What is the Akshaak Platform? | Radical Thinking",
  description:
    "Akshaak is a strategic branding for an e-commerce marketplace ecosystem.",
  openGraph: {
    title: "What is the Akshaak Platform?",
    description:
      "Strategic branding for an e-commerce marketplace ecosystem.",
    url: "https://radical-thinking.net/portfolio/akshaak",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/akshaak.webp",
        width: 1200,
        height: 630,
        alt: "Akshaak Platform Interface",
      },
    ],
  },
};

export default function AkshaakPage() {
  const project = {
    name: "Akshaak",
    description:
      "Akshaak is a strategic branding for an e-commerce marketplace ecosystem.",
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            By integrating E-commerce Branding principles with Marketplace Strategy, we&apos;ve created a system that 
            learns from shopper behavior to optimize retail identity in real-time.
          </p>
