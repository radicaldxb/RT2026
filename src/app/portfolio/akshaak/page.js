...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Strategic branding for an e-commerce marketplace ecosystem.",
    url: "https://radical-thinking.net/portfolio/akshaak",
    images: [{ url: "https://radical-thinking.net/Images/Portfolio/akshaak.webp", width: 1200, height: 630, alt: `${project.title} Platform Interface` }],
  },
};
