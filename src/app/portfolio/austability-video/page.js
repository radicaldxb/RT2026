...
export const metadata = {
  title: "What is the Austability Video Platform? | Radical Thinking",
  description:
    "Austability Video is high-impact corporate storytelling through video production focused on operational scale.",
  openGraph: {
    title: "What is the Austability Video Platform?",
    description:
      "High-impact corporate storytelling through video production focused on operational scale.",
    url: "https://radical-thinking.net/portfolio/austability-video",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/austability-video.webp",
        width: 1200,
        height: 630,
        alt: "Austability Video Platform Interface",
      },
    ],
  },
};

export default function AustabilityVideoPage() {
  const project = {
    name: "Austability Video",
    description:
      "Austability Video is high-impact corporate storytelling through video production focused on operational scale.",
    image: "/images/portfolio/austability-video.webp",
    ref: "austability-video",
  };
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            By integrating Corporate Storytelling principles with Operational Video, we&apos;ve created a system that 
            learns from viewer engagement to optimize brand narrative in real-time.
          </p>
