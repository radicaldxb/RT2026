...
export const metadata = {
  title: "What is the 1001 Inventions Games Platform? | Radical Thinking",
  description:
    "1001 Inventions Games are gamified educational experiences for physical installations and iPad interaction.",
  openGraph: {
    title: "What is the 1001 Inventions Games Platform?",
    description:
      "Gamified educational experiences for physical installations and iPad interaction.",
    url: "https://radical-thinking.net/portfolio/1001-inventions-games",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/1001-games.webp",
        width: 1200,
        height: 630,
        alt: "1001 Inventions Games Platform Interface",
      },
    ],
  },
};
...
export default function InventionsGamesPage() {
  const project = {
    name: "1001 Inventions Games",
    description:
      "1001 Inventions Games are gamified educational experiences for physical installations and iPad interaction.",
    image: "/images/portfolio/1001-games.webp",
    ref: "1001-inventions-games",
  };
