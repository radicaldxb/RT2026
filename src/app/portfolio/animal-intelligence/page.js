...
export const metadata = {
  title: "What is the Animal Intelligence Platform? | Radical Thinking",
  description:
    "Animal Intelligence is an enterprise AI engine designed to modernize the animal welfare sector, empowering governments and shelters with automated logistics and data-driven insights.",
  openGraph: {
    title: "What is the Animal Intelligence Platform?",
    description:
      "An enterprise AI engine designed to modernize the animal welfare sector.",
    url: "https://radical-thinking.net/portfolio/animal-intelligence",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/animal-intelligence.webp",
        width: 1200,
        height: 630,
        alt: "Animal Intelligence Platform Interface",
      },
    ],
  },
};
...
export default function AnimalIntelligencePage() {
  const project = {
    ...
    description:
      "Animal Intelligence is an enterprise AI engine designed to modernize the animal welfare sector. It empowers governments and shelters by automating complex logistics and providing data-driven insights, enabling organizations to streamline operations, improve response times, and make smarter governance decisions based on real-time analytics.",
