...
export const metadata = {
  title: "What is the Webinarlife Platform? | Radical Thinking",
  description:
    "Webinarlife is an end-to-end digital ecosystem and branding for a sophisticated virtual events platform.",
  openGraph: {
    title: "What is the Webinarlife Platform?",
    description:
      "End-to-end digital ecosystem and branding for a sophisticated virtual events platform.",
    url: "https://radical-thinking.net/portfolio/webinarlife",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/webinarlife.webp",
        width: 1200,
        height: 630,
        alt: "Webinarlife Platform Interface",
      },
    ],
  },
};

export default function WebinarlifePage() {
  const project = {
    name: "Webinarlife",
    description:
      "Webinarlife is an end-to-end digital ecosystem and branding for a sophisticated virtual events platform.",
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from attendee behavior to optimize virtual experiences in real-time.
          </p>
