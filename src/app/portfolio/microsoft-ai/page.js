...
export const metadata = {
  title: "What is the Microsoft (AI) Platform? | Radical Thinking",
  description:
    "Microsoft (AI) is an enterprise-grade web project focusing on Microsoft's AI innovations and capabilities.",
  openGraph: {
    title: "What is the Microsoft (AI) Platform?",
    description:
      "Enterprise-grade web project focusing on Microsoft's AI innovations and capabilities.",
    url: "https://radical-thinking.net/portfolio/microsoft-ai",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/microsoft-ai.webp",
        width: 1200,
        height: 630,
        alt: "Microsoft (AI) Platform Interface",
      },
    ],
  },
};
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from user feedback to optimize enterprise capabilities in real-time.
          </p>
