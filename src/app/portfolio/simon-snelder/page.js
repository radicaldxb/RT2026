...
export const metadata = {
  title: "What is the Simon Snelder Platform? | Radical Thinking",
  description:
    "Simon Snelder is a premium branding and wealth management identity designed for high-net-worth engagement.",
  openGraph: {
    title: "What is the Simon Snelder Platform?",
    description:
      "Premium branding and wealth management identity designed for high-net-worth engagement.",
    url: "https://radical-thinking.net/portfolio/simon-snelder",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/simonsnelder.webp",
        width: 1200,
        height: 630,
        alt: "Simon Snelder Platform Interface",
      },
    ],
  },
};
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from engagement metrics to optimize brand resonance in real-time.
          </p>
