...
export const metadata = {
  title: "What is the Lenovo Campaigns Platform? | Radical Thinking",
  description:
    "Lenovo Campaigns are integrated multi-channel campaigns spanning web design and digital marketing assets.",
  openGraph: {
    title: "What is the Lenovo Campaigns Platform?",
    description:
      "Integrated multi-channel campaigns spanning web design and digital marketing assets.",
    url: "https://radical-thinking.net/portfolio/lenovo-campaigns",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/lenovo.webp",
        width: 1200,
        height: 630,
        alt: "Lenovo Campaigns Platform Interface",
      },
    ],
  },
};
...
export default function LenovoCampaignsPage() {
  const project = {
    name: "Lenovo Campaigns",
    description:
      "Lenovo Campaigns are integrated multi-channel campaigns spanning web design and digital marketing assets.",
    image: "/images/portfolio/lenovo.webp",
    ref: "lenovo-campaigns",
  };
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from campaign performance to optimize retail impact in real-time.
          </p>
