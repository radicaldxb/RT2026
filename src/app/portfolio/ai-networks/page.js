...
export const metadata = {
  ...
  alternates: {
    canonical: "https://radical-thinking.net/portfolio/ai-networks",
  },
  openGraph: {
    title: `${project.title} | Radical Thinking Portfolio`,
    description: project.description,
    url: "https://radical-thinking.net/portfolio/ai-networks",
    images: [
      {
...
export default function AINetworksPage() {
  return (
    <>
