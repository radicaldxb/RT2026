...
export const metadata = {
  title: "What is the Influence My World Platform? | Radical Thinking",
  description:
    "Influence My World is a global influencer agency branding focused on social connection and creator impact.",
  openGraph: {
    title: "What is the Influence My World Platform?",
    description:
      "Global influencer agency branding focused on social connection and creator impact.",
    url: "https://radical-thinking.net/portfolio/influence-my-world",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/influence-my-world.webp",
        width: 1200,
        height: 630,
        alt: "Influence My World Platform Interface",
      },
    ],
  },
};

export default function InfluenceMyWorldPage() {
  const project = {
    name: "Influence My World",
    description:
      "Influence My World is a global influencer agency branding focused on social connection and creator impact.",
    image: "/images/portfolio/influence-my-world.webp",
    ref: "influence-my-world",
  };
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            By integrating Creator Economy principles with Influencer Agency Branding, we&apos;ve created a system that 
            learns from social trends to optimize creator impact in real-time.
          </p>
