...
export const metadata = {
  ...
  description:
    "Tommy & Ellie is a pioneering initiative merging generative AI with fine art to create bespoke, high-end portraits for the global pet-owner community.",
  openGraph: {
    title: "What is the Tommy & Ellie Platform?",
    description:
      "A pioneering initiative merging generative AI with fine art for bespoke pet portraits.",
    url: "https://radical-thinking.net/portfolio/tommy-ellie",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/tommy-ellie.webp",
        width: 1200,
        height: 630,
        alt: "Tommy & Ellie Platform Interface",
      },
    ],
  },
};
