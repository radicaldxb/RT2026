...
export const metadata = {
  title: "What is the Crypto X Platform? | Radical Thinking",
  description:
    "Crypto X is a modern visual identity for the blockchain and cryptocurrency investment landscape.",
  openGraph: {
    title: "What is the Crypto X Platform?",
    description:
      "Modern visual identity for the blockchain and cryptocurrency investment landscape.",
    url: "https://radical-thinking.net/portfolio/crypto-x",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/crypto-x.webp",
        width: 1200,
        height: 630,
        alt: "Crypto X Platform Interface",
      },
    ],
  },
};
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from market dynamics to optimize brand identity in real-time.
          </p>
