...
export const metadata = {
  title: "What is the KFAS / 1001 Inventions Platform? | Radical Thinking",
  description:
    "KFAS / 1001 Inventions is an educational event website for a high-profile science and heritage festival.",
  openGraph: {
    title: "What is the KFAS / 1001 Inventions Platform?",
    description:
      "Educational event website for a high-profile science and heritage festival.",
    url: "https://radical-thinking.net/portfolio/kfas-1001-inventions",
    images: [
      {
        url: "https://radical-thinking.net/images/portfolio/kfas.webp",
        width: 1200,
        height: 630,
        alt: "KFAS / 1001 Inventions Platform Interface",
      },
    ],
  },
};

export default function KFAS1001InventionsPage() {
  const project = {
    name: "KFAS / 1001 Inventions",
    description:
      "KFAS / 1001 Inventions is an educational event website for a high-profile science and heritage festival.",
    image: "/images/portfolio/kfas.webp",
    ref: "kfas-1001-inventions",
  };
      ...
      <article className="relative z-10 flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        ...
        <section className="prose prose-lg max-w-none text-gray-700">
          ...
          <p className="mb-6">
            ...
            learns from visitor data to optimize educational engagement in real-time.
          </p>
