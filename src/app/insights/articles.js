...
const SIGNATURE = "Radical Insights. One sharp idea every week.";
...
export const articles = [
  {
    ...
    ctaTitle: "Ready to start with one thing?",
    ctaBody: "Tell the agent what workflow is stealing your time. It will help you figure out where to begin.",
    ...
    sections: [
      ...
      {
        title: "Rebuild instead of retrofit",
        paragraphs: [
      ...
      {
        title: "Expect Month 2 to be brutal",
        paragraphs: [
  ...
  },
  {
    ...
    readTime: "7 mins",
    tags: ["Strategy", "AI Transformation", "Future of Work"],
    ctaTitle: "Still automating the broken thing?",
    ctaBody: "Tell the agent what you are trying to fix. It will help you see whether you need a retrofit or a rebuild.",
    imageFrame: IMAGE_FRAME,
    leadQuote:
    ...
    intro:
      "Last week I said the businesses building AI capabilities now will have a compounding advantage. That's true. But I should have added the caveat: most won't build them at all. They'll try, fail quietly, and go back to what they know. Not because AI doesn't work. Because rollouts are designed to fail.",
    sections: [
      {
        title: "The gap between \"can\" and \"actually does\"",
        paragraphs: [
      ...
      {
        title: "The real problem: they don't actually know what AI can do",
        paragraphs: [
      ...
      {
        title: "Five patterns that give it away",
        paragraphs: [
          "They automate workflows instead of rethinking them. They take the process that exists and try to speed it up with AI. But the process exists because it had to, given the old constraints. AI removes those constraints. So they end up building elaborate prompt chains to replicate something that could be one sentence tomorrow.",
          "Inconsistency kills adoption because they're over-engineering. Prompt 1 feeds into Prompt 2 feeds into Prompt 3, with manual review in between. Each step adds fragility. Each handoff is a chance for the output to drift. They think they need complexity. They actually just need to step back and let AI do the whole thing at once.",
          "The person who benefits isn't learning what's possible. The owner wants their social posts done. But they never sit down and experiment with the AI themselves. So they don't discover that one good prompt can generate, refine, and schedule a whole week of posts.",
          "They're building systems that will be obsolete in three months. They deploy a workflow today that works. But next month the models get better. In six months, something that needed five steps works in one. Instead of staying curious about capability shifts, they freeze the system and move on.",
          "Nobody's measuring what's actually available versus what they're using. They don't track: \"This used to take four hours. Now it takes 30 minutes, but could it take five?\" Because they're not comparing against the full capability, they're comparing against the old way of doing things.",
        ],
      },
    ],
    closing: {
      title: "The compounding advantage belongs to those who actually learn",
      paragraphs: [
        "Last week's thesis still holds: the businesses that start building AI capabilities now will have an edge.",
        "But that edge doesn't come from moving faster. It comes from understanding what the technology can actually do and then having the courage to let go of the workflows it replaces.",
        ...
        "The businesses that win ask what this would look like if they could do it however they wanted — and then build that. Not the old way with AI on top. The new way, from scratch.",
  ...
  },
  {
    ...
    readTime: "5 mins",
    tags: ["Strategy", "AI Transformation", "Future of Work"],
    ctaTitle: "Running an agency in the AI era?",
    ctaBody: "Talk to the agent about where AI creates real value in your model — and where it does not.",
    imageFrame: IMAGE_FRAME,
    leadQuote:
    ...
    sections: [
      {
        title: "Nobody is coming to save the old model",
        paragraphs: [
      ...
      {
        title: "The gap is not the technology. It is the translation.",
        paragraphs: [
      ...
      {
        title: "The agency that survives is the one that closes that gap",
        paragraphs: [
    ...
    closing: {
      title: "You do not need to become a technology company",
      paragraphs: [
        "You need one person in your corner who has already done the work of figuring out where AI creates real value and where it does not — and can help you build it into how you operate without turning your business upside down.",
  ...
  },
  {
    ...
    readTime: "4 mins",
    tags: ["Strategy", "AI Transformation", "Future of Work"],
    ctaTitle: "Ready to re-engineer the engine?",
    ctaBody: "Tell the agent what you are running today. It will help you see what needs to change before you add more fuel.",
    imageFrame: IMAGE_FRAME,
    leadQuote:
    ...
    sections: [
      {
        title: "The end of the billable hour",
        paragraphs: [
      ...
      {
        title: "The rocket fuel metaphor",
        paragraphs: [
      ...
      {
        title: "The future belongs to the architects",
        paragraphs: [
      ...
      },
      {
        ...
        quote: "We stopped building Honda Civics. We re-engineered Radical Thinking to run on rocket fuel.",
      },
    ],
    closing: {
      paragraphs: [
        "The question is not whether AI changes your industry. It already has. The question is whether you are still pouring rocket fuel into an engine that was never built for it.",
      ],
      signature: SIGNATURE,
    },
  },
  {
    ...
    readTime: "5 mins",
    tags: ["Strategy", "AI Transformation", "Future of Work"],
    ctaTitle: "Want to see the architecture in action?",
    ctaBody: "Ask the agent how FluffyFriends works — or tell it about a product you want to build the same way.",
    imageFrame: IMAGE_FRAME,
    leadQuote: "Prompting isn't the product. Architecture is.",
    intro:
    ...
    sections: [
      {
        title: "The \"I can do that for free\" fallacy",
        paragraphs: [
      ...
      {
        title: "The end-to-end architecture",
        paragraphs: [
          "We transformed a process that usually gets users stuck into a fully automated flow.",
          "Computer vision validation: our AI instantly checks uploads and rejects unclear pet faces before the customer even pays.",
          "Theme matching: the system isolates the pet's exact features and integrates them into complex, pre-engineered themes.",
          "Identity locking: it automatically embeds the pet's specific name directly into the geometry of the artwork.",
          "Autonomous quality assurance: a secondary AI checks the output for hallucinations. If it fails our quality standard, it silently retries the generation.",
          "8K upscaling: approved images are rendered in massive, print-ready resolutions (portrait and landscape).",
          "Delivery: the user receives the files alongside a print guide and template for local printing.",
        ],
      },
      {
        title: "The 80/20 rule of AI engineering",
        paragraphs: [
          "We built this entire product relying on an 80/20 split: 80% is pure AI automation, 20% is human logic.",
    ...
    closing: {
      ...
      paragraphs: [
        "Visit fluffyfriends.online and use the code Fluffy15 to get 15% off your first order.",
        "This is what zero-touch architecture looks like when you stop treating AI as a toy and start treating it as infrastructure.",
      ],
      signature: SIGNATURE,
    },
  },
